...
// Saves the account after PIN setup.
// Opens the activation screens when registration finishes.

import { registerProfile } from '@/shared/account/repository';
import { QuestionFields } from './Fields';
import { getStarted } from './content';
import { isStepReady } from './validation';
...
export default function GetStartedScreen() {
  ...
  const question = getStarted.steps[step];
    ...
    <>
      ...
      >
        <Text style={s.flowEyebrow}>
          {step + 1}/{getStarted.steps.length}
        </Text>
