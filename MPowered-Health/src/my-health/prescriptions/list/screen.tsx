...
export default function PrescriptionsScreen() {
  ...
  return (
    <Shell title="My Prescriptions" onBack={() => router.replace('/(tabs)/myhealth')}>
            ...
            <View key={item.id} style={s.med}>
              ...
              <View style={s.medActions}>
                <Pressable
                  ...
                  style={s.iconButton}
                  onPress={() => {
                    router.push({ pathname: '/(tabs)/myhealth/prescriptions/edit', params: { id: item.id } });
                  }}
                >
      ...
      <ActionButton
        ...
        onPress={() => {
          router.push('/(tabs)/myhealth/prescriptions/new');
        }}
      />
    </Shell>
  );
