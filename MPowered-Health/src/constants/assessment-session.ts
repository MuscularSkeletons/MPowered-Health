...
export function markAssessmentCompleted(type: string, answers?: AssessmentAnswers) {
  ...
  if(answers)assessmentAnswers.set(type,Object.fromEntries(Object.entries(answers).map(([step,values])=>[step,[...values]])));
}
...
export function getAssessmentAnswers(type:string) {
  ...
  return answers?Object.fromEntries(Object.entries(answers).map(([step,values])=>[step,[...values]])):undefined;
}
