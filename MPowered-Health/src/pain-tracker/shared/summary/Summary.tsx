/** Shows assessment results and lets users reopen their answers for editing. */
import type {
  AssessmentAnswers,
...
export function AssessmentSummary({
  ...
  return (
    <SafeAreaView style={s.safe} edges={['top']}>
      <MhaHeader />
      <ScrollView style={s.body} contentContainerStyle={s.summary}>
        ...
        <View style={s.summaryFooter}>
          {presentation.savedLabel ? <Text style={s.saved}>{presentation.savedLabel}</Text> : null}
          {/* All five assessments can reopen their existing answers. */}
          <Pressable accessibilityRole="button" style={s.closeButton} onPress={onRestart}>
            <Text style={s.closeText}>Edit</Text>
          </Pressable>
          <Pressable
