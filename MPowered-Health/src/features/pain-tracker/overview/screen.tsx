...
import { s } from '@/features/pain-tracker/overview/styles';
// This screen is the app home page and shows weekly assessment progress.
import { getProfile } from '@/features/account/repository';
import { getCompletedAssessments, getWeeklyStreak } from '@/features/pain-tracker/session';
import { getReflection } from '@/features/pain-tracker/reflection/repository';
import { MhaHeader } from '@/shared/ui/mha-ui';
import { router, useFocusEffect, useLocalSearchParams } from 'expo-router';
import { useCallback, useState } from 'react';
import { Pressable, ScrollView, Text, View } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { content } from '@/features/pain-tracker/overview/content';
