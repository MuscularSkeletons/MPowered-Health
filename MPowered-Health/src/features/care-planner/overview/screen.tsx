import { s } from '@/features/care-planner/overview/styles';
// This screen shows care-planning tools, appointments, and questions for clinicians.
import { getAppointments } from '@/features/care-planner/shared/repository';
import { ActionButton, MhaHeader, PageIntro } from '@/shared/ui/mha-ui';
import { router, useFocusEffect } from 'expo-router';
import { useCallback, useState } from 'react';
import { ScrollView, Text, View } from 'react-native';
import { SafeAreaView } from 'react-native-safe-area-context';
import { content } from '@/features/care-planner/overview/content';
