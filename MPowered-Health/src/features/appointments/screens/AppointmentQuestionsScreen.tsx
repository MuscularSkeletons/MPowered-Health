import { buildAppointmentQuestions } from '@/features/appointments/services/question-suggestions';
import { getPainHistory, painRecordDate } from '@/features/pain/services/pain-history';
